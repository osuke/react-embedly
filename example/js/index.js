...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(_react2.default.createElement(_index2.default, { url: 'https://facebook.github.io/react/', apiKey: 'ff6dc30026d7471787fd22c4bc23eef6' }), document.getElementById('content'));
	...
	var Embedly = function (_React$Component) {
	  ...
	  _createClass(Embedly, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement('a', { className: 'embedly', href: this.state.url, style: aStyle }, _react2.default.createElement('div', { className: 'embedly__image', style: imageStyle }, _react2.default.createElement('img', { src: this.state.thumbnail_url, alt: this.state.title, style: imgStyle })), _react2.default.createElement('div', { className: 'embedly__text', style: textStyle }, _react2.default.createElement('p', { className: 'embedly__title', style: titleStyle }, this.state.title), _react2.default.createElement('p', { className: 'embedly__desc', style: descStyle }, this.state.description), _react2.default.createElement('p', { className: 'embedly__provider', style: providerStyle }, this.state.provider_url)));
	    }
	  }]);
